...
func main() {
	...
	protected.HandleFunc("/target-groups/{id}/targets", platformHandler.RegisterLBTarget).Methods("POST")
	...
	protected.HandleFunc("/load-balancers/{id}/listeners/{listener_id}", platformHandler.DeleteLBListener).Methods("DELETE")
